...
PRETRAIN_LENGTH = 4 * 256  # each sample is a 4-second recording at 256 Hz

# configurations for various model scales
# depth means the number of transformer blocks in each stage (encoder, predictor, reconstructor)
MODELS_CONFIGS = {
    "tiny1": {
