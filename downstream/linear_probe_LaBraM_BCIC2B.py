...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.feature        = model
        self.head   =   LinearWithConstraint(2600, 2, max_norm=1)#
...
for i in range(1,10):
    ...
    train_dataset,valid_dataset,test_dataset = get_data_BCIC(
        i,data_path,1, is_few_EA = True, target_sample=200*4)
    ...
    trainer = pl.Trainer(accelerator='cuda',
                        ...
                        #  strategy=DDPStrategy(find_unused_parameters=True),
                         ...
                         logger=[pl_loggers.TensorBoardLogger('./logs/', name="LaBraM_BCIC2B_tb", version=f"subject{i}"), 
                                 pl_loggers.CSVLogger('./logs/', name="LaBraM_BCIC2B_csv")])
